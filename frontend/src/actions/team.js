...
export const updateMemberRole = (teamId, userId, newRole) => async dispatch => {
    ...
    try {
        const res = await axios.patch(`${process.env.REACT_APP_API_URL}/api/teams/${teamId}/update_member_role/`, body, config);
...
export const removeMember = (teamId, userId) => async dispatch => {
    ...
    try {
        await axios.delete(`${process.env.REACT_APP_API_URL}/api/teams/${teamId}/remove_member/`, config);
