...
const Dashboard = ({ isAuthenticated, firstLogin, resetFirstLogin, user }) => {
    ...
    useEffect(() => {
        const fetchTasks = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/tasks/user-and-team-tasks/`, { withCredentials: true });
        ...
        const fetchTeams = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/teams/`, { withCredentials: true });
